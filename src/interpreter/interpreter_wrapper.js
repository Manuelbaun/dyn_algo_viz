...
export class InterpreterWrapper {
  ...
  async setup() {
     ...
     */
    this.interpreterController = function (self, globalObject) {
      /** **************** */
      /** Define Props     */
      /** **************** */
  ...
  run() {
    ...
    const interpreter = new Interpreter(code, this.interpreterController);
...
//  * @param {ComparisonSorts} algorithm
//  */
// export async function setupAlgorithm(algorithm) {
//   await algorithm.setup();
